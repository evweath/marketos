...
export const SAMPLE_TRAFFIC: Record<string, TrafficMetrics> = {
  'donut-equipment': {
    ...
    sources: [
      { source: 'Organic', value: 34, color: '#10d98a' },
      { source: 'Paid Google', value: 28, color: '#00d9ff' },
      { source: 'Direct', value: 18, color: '#7b93ff' },
  ...
  'donut-supplies': {
    ...
    sources: [
      { source: 'Organic', value: 29, color: '#10d98a' },
      { source: 'Paid Google', value: 31, color: '#00d9ff' },
      { source: 'Direct', value: 16, color: '#7b93ff' },
      { source: 'Email', value: 14, color: '#ffb347' },
      { source: 'Social', value: 10, color: '#ff4444' },
    ],
  },
  'bakery-wholesalers': {
    ...
    sources: [
      { source: 'Organic', value: 42, color: '#10d98a' },
      { source: 'Direct', value: 24, color: '#7b93ff' },
      { source: 'Paid Google', value: 19, color: '#00d9ff' },
      { source: 'Email', value: 10, color: '#ffb347' },
